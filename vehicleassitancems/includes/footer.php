...
{               ?>
                                <!-- small logo start -->
                                <a href="index.php" class="footer-logo"> <strong style="color:white ;font-weight: bold;"> Live On Road Assistance Service</strong> </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-4">
                        ...
                        <div class="footer-copyright">
                            <p> Live On Road Assistance Service @2023</p>
                        </div>
                        <!-- copyright text end -->
                    </div>
