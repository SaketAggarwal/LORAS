                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9">
                                    <!-- layer 1 -->
                                    <div class="layer-1-1">
                                        <h2 class="title-1">LORAS  </h2>
                                    </div>
                                    <!-- layer 2 -->
                                    <div class="layer-1-2">
                                        <h2 class="title-2"> Live-On-Road Assistance Service </h2>
                                    </div>
                                    <!-- layer 3 -->
                                    <div class="layer-1-3">
                                        <!-- <p class="title-3"> </p> -->
...
{               ?>
                            <p>Emergency support provided in the event of any mechanical/electrical breakdown or traffic accident of the vehicle. ... If your car has met with a major defect and is immovable, we will help you to fix your car at that moment or take it to the nearest workshop or legal authorities</p>
